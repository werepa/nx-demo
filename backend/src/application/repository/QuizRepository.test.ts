...
describe("QuizRepository", () => {
  ...
  test("should create fixture data", () => {
    ...
    expect(direitosGarantiasIndividuais.name).toBe(
  ...
  test("should get statistics from user learning", async () => {
    ...
    expect(
      learning1.topics.findByTopicId(crase.topicId)?.frequencyInDepth,
    ).toBe(100)
    expect(
      learning1.topics.findByTopicId(crase.topicId)?.frequencyInDiscipline,
    ).toBe(1)
    expect(learning1.topics.findByTopicId(crase.topicId)?.qtyQuestions).toBe(4)
    expect(
      learning1.topics.findByTopicId(crase.topicId)?.qtyQuestionsAnswered(),
    ).toBe(0)
    expect(
      learning1.topics
        .findByTopicId(crase.topicId)
        ?.qtyQuestionsCorrectAnswered(),
    ).toBe(0)
    expect(learning1.topics.findByTopicId(crase.topicId)?.avgGrade()).toBe(null)
    expect(
      learning1.topics.findByTopicId(crase.topicId)?.collectiveAvgGrade,
    ).toBe(null)
  })
  ...
  describe("Calculate statistics learning of a topic of discipline", () => {
    ...
    test("should have required parameters", () => {
      ...
      expect(() => learning1.topics.findByTopicId()).toThrow(
    ...
    test("should calculate maxDepth of topic in discipline", () => {
      expect(portugues?.statistics(portuguesClassificar.topicId).maxDepth).toBe(
        1,
      )
    ...
    test("should calculate qtyChildren of topic in discipline", () => {
      expect(
        portugues?.statistics(portuguesClassificar.topicId).qtyChildren,
      ).toBe(0)
      expect(portugues?.statistics(crase.topicId).qtyChildren).toBe(4)
      expect(portugues?.statistics(palavrasRepetidas.topicId).qtyChildren).toBe(
        0,
      )
      expect(
        portugues?.statistics(palavrasMasculinas.topicId).qtyChildren,
      ).toBe(0)
      expect(portugues?.statistics(palavrasEspeciais.topicId).qtyChildren).toBe(
        2,
      )
    ...
    test("should calculate qtyChildrenRecursive of topic in discipline", () => {
      expect(
        portugues?.statistics(portuguesClassificar.topicId)
          .qtyChildrenRecursive,
      ).toBe(0)
      expect(portugues?.statistics(crase.topicId).qtyChildrenRecursive).toBe(6)
      expect(
        portugues?.statistics(palavrasRepetidas.topicId).qtyChildrenRecursive,
      ).toBe(0)
      expect(
        portugues?.statistics(palavrasMasculinas.topicId).qtyChildrenRecursive,
      ).toBe(0)
      expect(
        portugues?.statistics(palavrasEspeciais.topicId).qtyChildrenRecursive,
      ).toBe(2)
      expect(
        portugues?.statistics(distancia.topicId).qtyChildrenRecursive,
      ).toBe(0)
      expect(portugues?.statistics(terra.topicId).qtyChildrenRecursive).toBe(0)
      expect(
        portugues?.statistics(nomesCidades.topicId).qtyChildrenRecursive,
      ).toBe(0)
      expect(portugues?.statistics(pronomes.topicId).qtyChildrenRecursive).toBe(
        4,
      )
      expect(portugues?.statistics(pessoais.topicId).qtyChildrenRecursive).toBe(
        2,
      )
      expect(portugues?.statistics(casoReto.topicId).qtyChildrenRecursive).toBe(
        0,
      )
      expect(portugues?.statistics(obliquos.topicId).qtyChildrenRecursive).toBe(
        0,
      )
      expect(
        portugues?.statistics(tratamento.topicId).qtyChildrenRecursive,
      ).toBe(0)
    })

    test("should calculate qtyQuestions of topic in discipline", () => {
      expect(
        learning1.topics.findByTopicId(portuguesClassificar.topicId)
          ?.qtyQuestions,
      ).toBe(1)
      expect(learning1.topics.findByTopicId(crase.topicId)?.qtyQuestions).toBe(
        4,
      )
      expect(
        learning1.topics.findByTopicId(palavrasRepetidas.topicId)?.qtyQuestions,
      ).toBe(1)
      expect(
        learning1.topics.findByTopicId(palavrasMasculinas.topicId)
          ?.qtyQuestions,
      ).toBe(1)
      expect(
        learning1.topics.findByTopicId(palavrasEspeciais.topicId)?.qtyQuestions,
      ).toBe(0)
      expect(
        learning1.topics.findByTopicId(distancia.topicId)?.qtyQuestions,
      ).toBe(2)
      expect(learning1.topics.findByTopicId(terra.topicId)?.qtyQuestions).toBe(
        3,
      )
      expect(
        learning1.topics.findByTopicId(nomesCidades.topicId)?.qtyQuestions,
      ).toBe(0)
      expect(
        learning1.topics.findByTopicId(pronomes.topicId)?.qtyQuestions,
      ).toBe(3)
      expect(
        learning1.topics.findByTopicId(pessoais.topicId)?.qtyQuestions,
      ).toBe(0)
      expect(
        learning1.topics.findByTopicId(casoReto.topicId)?.qtyQuestions,
      ).toBe(3)
      expect(
        learning1.topics.findByTopicId(obliquos.topicId)?.qtyQuestions,
      ).toBe(1)
      expect(
        learning1.topics.findByTopicId(tratamento.topicId)?.qtyQuestions,
      ).toBe(2)
    })
    ...
    test("should calculate qtyQuestionsRecursive of topic in discipline", () => {
      expect(
        learning1.topics.findByTopicId(portuguesClassificar.topicId)
          ?.qtyQuestionsRecursive,
      ).toBe(0)
      expect(
        learning1.topics.findByTopicId(crase.topicId)?.qtyQuestionsRecursive,
      ).toBe(7)
      expect(
        learning1.topics.findByTopicId(palavrasRepetidas.topicId)
          ?.qtyQuestionsRecursive,
      ).toBe(0)
      expect(
        learning1.topics.findByTopicId(palavrasMasculinas.topicId)
      ...
      expect(
        learning1.topics.findByTopicId(palavrasEspeciais.topicId)
          ?.qtyQuestionsRecursive,
      ).toBe(5)
      expect(
        learning1.topics.findByTopicId(distancia.topicId)
          ?.qtyQuestionsRecursive,
      ).toBe(0)
      expect(
        learning1.topics.findByTopicId(terra.topicId)?.qtyQuestionsRecursive,
      ).toBe(0)
      expect(
        learning1.topics.findByTopicId(nomesCidades.topicId)
          ?.qtyQuestionsRecursive,
      ).toBe(0)
      expect(
        learning1.topics.findByTopicId(pronomes.topicId)?.qtyQuestionsRecursive,
      ).toBe(6)
      expect(
        learning1.topics.findByTopicId(pessoais.topicId)?.qtyQuestionsRecursive,
      ).toBe(4)
      expect(
        learning1.topics.findByTopicId(casoReto.topicId)?.qtyQuestionsRecursive,
      ).toBe(0)
      expect(
        learning1.topics.findByTopicId(obliquos.topicId)?.qtyQuestionsRecursive,
      ).toBe(0)
      expect(
        learning1.topics.findByTopicId(tratamento.topicId)
          ?.qtyQuestionsRecursive,
      ).toBe(0)
    })
    ...
    test("should calculate qtyAllQuestionsDepth of topic in discipline", () => {
      expect(
        learning1.topics.findByTopicId(portuguesClassificar.topicId)
          ?.qtyAllQuestionsDepth,
      ).toBe(1)
      expect(
        learning1.topics.findByTopicId(crase.topicId)?.qtyAllQuestionsDepth,
      ).toBe(11)
      expect(
        learning1.topics.findByTopicId(palavrasRepetidas.topicId)
          ?.qtyAllQuestionsDepth,
      ...
      expect(
        learning1.topics.findByTopicId(distancia.topicId)?.qtyAllQuestionsDepth,
      ).toBe(2)
      expect(
        learning1.topics.findByTopicId(terra.topicId)?.qtyAllQuestionsDepth,
      ).toBe(3)
      expect(
        learning1.topics.findByTopicId(nomesCidades.topicId)
          ?.qtyAllQuestionsDepth,
      ...
      expect(
        learning1.topics.findByTopicId(pronomes.topicId)?.qtyAllQuestionsDepth,
      ).toBe(9)
      expect(
        learning1.topics.findByTopicId(pessoais.topicId)?.qtyAllQuestionsDepth,
      ).toBe(4)
      expect(
        learning1.topics.findByTopicId(casoReto.topicId)?.qtyAllQuestionsDepth,
      ).toBe(3)
      expect(
        learning1.topics.findByTopicId(obliquos.topicId)?.qtyAllQuestionsDepth,
      ).toBe(1)
      expect(
        learning1.topics.findByTopicId(tratamento.topicId)
          ?.qtyAllQuestionsDepth,
    ...
    test("should calculate qtyAllQuestionsRootRecursive of topic in discipline", () => {
      expect(
        learning1.topics.findByTopicId(portuguesClassificar.topicId)
          ?.maxQtyAllQuestionsRootRecursive,
      ).toBe(11)
      expect(
        learning1.topics.findByTopicId(crase.topicId)
          ?.maxQtyAllQuestionsRootRecursive,
      ).toBe(11)
      expect(
        learning1.topics.findByTopicId(palavrasRepetidas.topicId)
      ...
      expect(
        learning1.topics.findByTopicId(terra.topicId)
          ?.maxQtyAllQuestionsRootRecursive,
      ).toBe(11)
      expect(
        learning1.topics.findByTopicId(nomesCidades.topicId)
      ...
      expect(
        learning1.topics.findByTopicId(pronomes.topicId)
          ?.maxQtyAllQuestionsRootRecursive,
      ).toBe(11)
      expect(
        learning1.topics.findByTopicId(pessoais.topicId)
          ?.maxQtyAllQuestionsRootRecursive,
      ).toBe(11)
      expect(
        learning1.topics.findByTopicId(casoReto.topicId)
          ?.maxQtyAllQuestionsRootRecursive,
      ).toBe(11)
      expect(
        learning1.topics.findByTopicId(obliquos.topicId)
          ?.maxQtyAllQuestionsRootRecursive,
      ).toBe(11)
      expect(
        learning1.topics.findByTopicId(tratamento.topicId)
    ...
    test("should calculate frequencyInDepth of topic in discipline", () => {
      ...
      expect(
        learning1.topics.findByTopicId(distancia.topicId)?.frequencyInDepth,
      ).toBe(0.6667)
      expect(
        learning1.topics.findByTopicId(terra.topicId)?.frequencyInDepth,
      ).toBe(1)
      expect(
        learning1.topics.findByTopicId(nomesCidades.topicId)?.frequencyInDepth,
      ).toBe(0.0)
      expect(
        learning1.topics.findByTopicId(pronomes.topicId)?.frequencyInDepth,
      ).toBe(81.8182)
      expect(
        learning1.topics.findByTopicId(pessoais.topicId)?.frequencyInDepth,
      ).toBe(8)
      expect(
        learning1.topics.findByTopicId(casoReto.topicId)?.frequencyInDepth,
      ).toBe(1)
      expect(
        learning1.topics.findByTopicId(obliquos.topicId)?.frequencyInDepth,
      ).toBe(0.3333)
      expect(
        learning1.topics.findByTopicId(tratamento.topicId)?.frequencyInDepth,
      ).toBe(4)
    })
    ...
    test("should calculate frequencyInDiscipline of topic in discipline", () => {
      ...
      expect(
        learning1.topics.findByTopicId(terra.topicId)?.frequencyInDiscipline,
      ).toBe(0.2727)
      expect(
        learning1.topics.findByTopicId(nomesCidades.topicId)
          ?.frequencyInDiscipline,
      ...
      expect(
        learning1.topics.findByTopicId(pronomes.topicId)?.frequencyInDiscipline,
      ).toBe(0.8182)
      expect(
        learning1.topics.findByTopicId(pessoais.topicId)?.frequencyInDiscipline,
      ).toBe(0.3636)
      expect(
        learning1.topics.findByTopicId(casoReto.topicId)?.frequencyInDiscipline,
      ).toBe(0.2727)
      expect(
        learning1.topics.findByTopicId(obliquos.topicId)?.frequencyInDiscipline,
      ).toBe(0.0909)
      expect(
        learning1.topics.findByTopicId(tratamento.topicId)
          ?.frequencyInDiscipline,
    ...
    test("should calculate user qtyQuestionsCorrectAnswered of topic in discipline", () => {
      expect(
        learning1.topics
          .findByTopicId(portuguesClassificar.topicId)
          ?.qtyQuestionsCorrectAnswered(),
      ).toBe(0)
      expect(
        learning1.topics
      ...
      expect(
        learning1.topics
          .findByTopicId(palavrasRepetidas.topicId)
          ?.qtyQuestionsCorrectAnswered(),
      ).toBe(1)
      expect(
        learning1.topics
          .findByTopicId(palavrasMasculinas.topicId)
          ?.qtyQuestionsCorrectAnswered(),
      ).toBe(0)
      expect(
        learning1.topics
          .findByTopicId(palavrasEspeciais.topicId)
          ?.qtyQuestionsCorrectAnswered(),
      ).toBe(0)
      expect(
        learning1.topics
          .findByTopicId(distancia.topicId)
          ?.qtyQuestionsCorrectAnswered(),
      ).toBe(2)
      expect(
        learning1.topics
          .findByTopicId(terra.topicId)
          ?.qtyQuestionsCorrectAnswered(),
      ).toBe(1)
      expect(
        learning1.topics
          .findByTopicId(nomesCidades.topicId)
          ?.qtyQuestionsCorrectAnswered(),
      ).toBe(0)
      expect(
        learning1.topics
          .findByTopicId(pronomes.topicId)
          ?.qtyQuestionsCorrectAnswered(),
      ).toBe(2)
      expect(
        learning1.topics
          .findByTopicId(pessoais.topicId)
          ?.qtyQuestionsCorrectAnswered(),
      ).toBe(0)
      expect(
        learning1.topics
          .findByTopicId(casoReto.topicId)
          ?.qtyQuestionsCorrectAnswered(),
      ).toBe(0)
      expect(
        learning1.topics
          .findByTopicId(obliquos.topicId)
          ?.qtyQuestionsCorrectAnswered(),
      ).toBe(0)
      expect(
        learning1.topics
          .findByTopicId(tratamento.topicId)
          ?.qtyQuestionsCorrectAnswered(),
      ).toBe(0)
    })
    ...
    test("should calculate user qtyQuestionsAnswered of topic in discipline", () => {
      ...
      expect(
        learning1.topics.findByTopicId(terra.topicId)?.qtyQuestionsAnswered(),
      ).toBe(2)
      expect(
        learning1.topics
          .findByTopicId(nomesCidades.topicId)
    ...
    test("should calculate user avgGrade of topic in discipline", () => {
      ...
      expect(learning1.topics.findByTopicId(crase.topicId)?.avgGrade()).toBe(
        33.33,
      )
      expect(
        learning1.topics.findByTopicId(palavrasRepetidas.topicId)?.avgGrade(),
      ).toBe(100)
      expect(
        learning1.topics.findByTopicId(palavrasMasculinas.topicId)?.avgGrade(),
      ).toBe(null)
      expect(
        learning1.topics.findByTopicId(palavrasEspeciais.topicId)?.avgGrade(),
      ).toBe(null)
      expect(
        learning1.topics.findByTopicId(distancia.topicId)?.avgGrade(),
      ).toBe(100)
      expect(learning1.topics.findByTopicId(terra.topicId)?.avgGrade()).toBe(50)
      expect(
        learning1.topics.findByTopicId(nomesCidades.topicId)?.avgGrade(),
      ).toBe(null)
      expect(learning1.topics.findByTopicId(pronomes.topicId)?.avgGrade()).toBe(
        100,
      )
      expect(learning1.topics.findByTopicId(pessoais.topicId)?.avgGrade()).toBe(
        null,
      )
      expect(learning1.topics.findByTopicId(casoReto.topicId)?.avgGrade()).toBe(
        null,
      )
      expect(learning1.topics.findByTopicId(obliquos.topicId)?.avgGrade()).toBe(
        null,
      )
      expect(
        learning1.topics.findByTopicId(tratamento.topicId)?.avgGrade(),
      ).toBe(null)
    })
    ...
    test("should calculate collectiveAvgGrade of topic in discipline", () => {
      ...
      expect(
        learning1.topics.findByTopicId(distancia.topicId)?.collectiveAvgGrade,
      ).toBe(null)
      expect(
        learning1.topics.findByTopicId(terra.topicId)?.collectiveAvgGrade,
      ).toBe(null)
      expect(
        learning1.topics.findByTopicId(nomesCidades.topicId)
          ?.collectiveAvgGrade,
      ...
      expect(
        learning1.topics.findByTopicId(pronomes.topicId)?.collectiveAvgGrade,
      ).toBe(null)
      expect(
        learning1.topics.findByTopicId(pessoais.topicId)?.collectiveAvgGrade,
      ).toBe(null)
      expect(
        learning1.topics.findByTopicId(casoReto.topicId)?.collectiveAvgGrade,
      ).toBe(null)
      expect(
        learning1.topics.findByTopicId(obliquos.topicId)?.collectiveAvgGrade,
      ).toBe(null)
      expect(
        learning1.topics.findByTopicId(tratamento.topicId)?.collectiveAvgGrade,
      ).toBe(null)
    })
    ...
    test("should calculate difficulty of topic in discipline", () => {
      ...
      expect(learning1.topics.findByTopicId(crase.topicId)?.difficulty).toBe(
        45.84,
      )
      expect(
        learning1.topics.findByTopicId(palavrasRepetidas.topicId)?.difficulty,
      ).toBe(50)
      expect(
        learning1.topics.findByTopicId(palavrasMasculinas.topicId)?.difficulty,
      ).toBe(50)
      expect(
        learning1.topics.findByTopicId(palavrasEspeciais.topicId)?.difficulty,
      ).toBe(50)
      expect(
        learning1.topics.findByTopicId(distancia.topicId)?.difficulty,
      ).toBe(50)
      expect(learning1.topics.findByTopicId(terra.topicId)?.difficulty).toBe(50)
      expect(
        learning1.topics.findByTopicId(nomesCidades.topicId)?.difficulty,
      ).toBe(50)
      expect(learning1.topics.findByTopicId(pronomes.topicId)?.difficulty).toBe(
        50,
      )
      expect(learning1.topics.findByTopicId(pessoais.topicId)?.difficulty).toBe(
        50,
      )
      expect(learning1.topics.findByTopicId(casoReto.topicId)?.difficulty).toBe(
        50,
      )
      expect(learning1.topics.findByTopicId(obliquos.topicId)?.difficulty).toBe(
        50,
      )
      expect(
        learning1.topics.findByTopicId(tratamento.topicId)?.difficulty,
      ).toBe(50)
    })
    ...
    test("should calculate difficultyRecursive of topic in discipline", () => {
      ...
      expect(
        learning1.topics.findByTopicId(crase.topicId)?.difficultyRecursive,
      ).toBe(49.41)
      expect(
        learning1.topics.findByTopicId(palavrasRepetidas.topicId)
          ?.difficultyRecursive,
      ...
      expect(
        learning1.topics.findByTopicId(distancia.topicId)?.difficultyRecursive,
      ).toBe(50)
      expect(
        learning1.topics.findByTopicId(terra.topicId)?.difficultyRecursive,
      ).toBe(50)
      expect(
        learning1.topics.findByTopicId(nomesCidades.topicId)
          ?.difficultyRecursive,
      ...
      expect(
        learning1.topics.findByTopicId(pronomes.topicId)?.difficultyRecursive,
      ).toBe(50)
      expect(
        learning1.topics.findByTopicId(pessoais.topicId)?.difficultyRecursive,
      ).toBe(50)
      expect(
        learning1.topics.findByTopicId(casoReto.topicId)?.difficultyRecursive,
      ).toBe(50)
      expect(
        learning1.topics.findByTopicId(obliquos.topicId)?.difficultyRecursive,
      ).toBe(50)
      expect(
        learning1.topics.findByTopicId(tratamento.topicId)?.difficultyRecursive,
      ).toBe(50)
    })
  })
})
